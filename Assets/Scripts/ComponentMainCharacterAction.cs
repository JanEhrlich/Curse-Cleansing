...
public class ComponentMainCharacterAction
{
    ...
    public static float batJumpPercentage = 0.6f;          //Jump force reduction while being a bat
    public static float gravityPercentageBat = 0.5f;       //falling slower while being a bat
